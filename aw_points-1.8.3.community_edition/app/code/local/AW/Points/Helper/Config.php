...
class AW_Points_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    /**
     * "Show points block at product page" from system config
     */
    const SHOW_POINTS_AT_PRODUCT_PAGE = 'points/general/points_block_at_product_page';
     ...
     *  The order in which collect totals are applied
     */
    const POINTS_SPENDING_CALCULATION = 'points/general/calculate_spending_points_order';
     ...
     * "Newsletter signup" from system config
     */
    const POINTS_EARNING_CONSIDER_NEWSLETTER_SIGNUP_BY_ADMIN
        = 'points/earning_points/consider_newsletter_signup_by_admin';
    ...
    /**
     * Minimum words count in the review
     */
    const EARNING_REVIEW_MINIMUM_WORDS_COUNT = 'points/earning_points/review_minimum_words_count';
    ...
    /**
     * Points for answering Product Question
     */
    const POINTS_EARNING_FOR_ANSWERING_PRODUCT_QUESTION = 'points/earning_points/for_answering_pq';
    //===========================REFERRAL SYSTEM==============================
    ...
    public function getShowPointsBlockAtProductPage($storeId = null)
    {
        return Mage::getStoreConfigFlag(self::SHOW_POINTS_AT_PRODUCT_PAGE, $storeId);
    }
    ...
    {
        return (int)Mage::getStoreConfig(self::POINTS_SPENDING_CALCULATION, $storeId);
    }
    ...
    public function getMinumumWordsCountInReview($storeId = null)
    {
        return (int)Mage::getStoreConfig(self::EARNING_REVIEW_MINIMUM_WORDS_COUNT, $storeId);
    }
    ...
    public function getPointsForAnsweringProductQuestion($storeId = null)
    {
        return (int)Mage::getStoreConfig(self::POINTS_EARNING_FOR_ANSWERING_PRODUCT_QUESTION, $storeId);
    }
