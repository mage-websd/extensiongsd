        ...
        foreach ($data as $item) {
            switch ($item->getStatus()) {
                ...
                case AW_Points_Model_Invitation::INVITEE_IS_CUSTOMER:
                    ...
                    break;
                case AW_Points_Model_Invitation::INVITATION_ACCEPTED_FROM_OTHER:
                    $item->setStatus($this->__('Invitation accepted (Not your affiliate)'));
                    break;
                case AW_Points_Model_Invitation::INVITEE_IS_CUSTOMER_FROM_OTHER:
                    $item->setStatus($this->__('Invitee became a customer (Not your affiliate)'));
                    break;
                default:
                    break;
            }
