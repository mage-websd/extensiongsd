            ...
            try {
                ...
                if ($testCoupon->getId() && ($testCoupon->getId() !== $data['coupon_id'])) {
                    ...
                    Mage::getSingleton('adminhtml/session')->addError(
                        Mage::helper('adminhtml')->__('Coupon with this code is already exists')
                    );
    ...
    public function deleteAction()
    {
        if ($id = $this->getRequest()->getParam('id')) {
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('points')->__('Coupon was successfully deleted')
                );
        ...
        Mage::getSingleton('adminhtml/session')->addError(
            Mage::helper('points')->__('Unable to find a coupon to delete')
        );
        return $this->_redirect('*/*/');
    }
