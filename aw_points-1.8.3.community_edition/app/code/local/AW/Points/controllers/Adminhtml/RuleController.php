...
class AW_Points_Adminhtml_RuleController extends Mage_Adminhtml_Controller_Action
{
        ...
        if ($id) {
            ...
            if (!$model->getRuleId()) {
                Mage::getSingleton('adminhtml/session')->addError(
                    Mage::helper('points')->__('This rule no longer exists')
                );
        ...
        if ($data = $this->getRequest()->getPost()) {
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('points')->__('Rule was successfully saved')
                );
                if ($redirectBack) {
                    $this->_redirect(
                        '*/*/edit', array(
    ...
    public function relatedGridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('points/adminhtml_rule_edit_tab_related')->toHtml()
        );
    }
