 ...
 * @version 2.0.61
 */
class Customweb_Subscription_Block_Adminhtml_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid {
	...
	public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element){
		...
		$chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')->setElement($element)->setTranslationHelper(
				$this->getTranslationHelper())->setConfig($this->getConfig())->setFieldsetId($this->getFieldsetId())->setSourceUrl($sourceUrl)->setUniqId(
				$uniqId);
	...
	public function getGridUrl(){
		return $this->getUrl('*/subscription/chooser', 
				array(
					'products_grid' => true,
					'_current' => true,
					'uniq_id' => $this->getId(),
